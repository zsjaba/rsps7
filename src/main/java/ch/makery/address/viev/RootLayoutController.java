...
public class RootLayoutController {
    ...
    private void handleNew() {
        mainApp.getClubData().clear();
        mainApp.setClubFilePath(null);
    }
    ...
    private void handleOpen() {
        ...
        if (file != null) {
            mainApp.loadClubDataFromFile(file);
        }
    }
    ...
    private void handleSave() {
        File clubFile = mainApp.getClubFilePath();
        if (clubFile != null) {
            mainApp.saveClubDataToFile(clubFile);
        } else {
            handleSaveAs();
        }
    }
    ...
    private void handleSaveAs() {
        ...
        if (file != null) {
            ...
            mainApp.saveClubDataToFile(file);
        }
    }
